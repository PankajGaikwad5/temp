...
export default function CategoryPage() {
  ...
  return (
    <main className='min-h-screen w-full bg-[#fdfcf9] relative'>
      ...
      {/* Hero Section */}
      <section
        className='relative w-full h-screen flex items-center justify-center bg-fixed bg-center bg-cover object-contain'
        style={{ backgroundImage: "url('../ringbg.webp')" }}
      >
        <img
          src='/ringbg.webp'
        ...
        <div
          className='absolute inset-0 bg-black/20 backdrop-blur-[1px] border border-white/20 shadow-inner'
          ref={bgImg}
        />
